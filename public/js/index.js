...
var renderItems = function renderItems(items) {
  ...
  for (var _i = 0, _Object$values = Object.values(items); _i < _Object$values.length; _i++) {
    var order = _Object$values[_i];
    mockup += "<li> ".concat(order.item.name, " - ").concat(order.qty, " Pcs </li>");
  }
...
var updateAdminOrder = function updateAdminOrder(formData) {
  axios__WEBPACK_IMPORTED_MODULE_0___default().post("/admin/orders/update", formData, {
    headers: {
...
(0,_stripe__WEBPACK_IMPORTED_MODULE_3__.initStripe)(); // remove order placed message
...
var fetchOrder = document.getElementById("getOrder");
var allStatus = document.querySelectorAll(".order_status");

var updateStatus = function updateStatus(order) {
  var updatedTime = document.createElement("small");
  var currentStatus = order.status;
  var moveForward = true; // remove status class
...
if (fetchOrder) {
  var parseData = JSON.parse(fetchOrder.value);
  updateStatus(parseData);
} // socket


var socket = (0,socket_io_client__WEBPACK_IMPORTED_MODULE_4__.io)(); // admin room
...
if (fetchOrder) {
  ...
  socket.emit("join", "order_".concat(_parseData._id));
}

socket.on("updateStatus", function (order) {
  new (noty__WEBPACK_IMPORTED_MODULE_1___default())({
    type: "success",
    text: "Status updated!!",
    timeout: 1000,
...
var initStripe = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee() {
    var orderForm, paymentMethod, stripe;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 5;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_3__.loadStripe)("pk_test_51HhHwxDTvrhXEQThe4i2exajqIwZZicp1O7YrIVKqwukFLpBJFTs0bXj3b98mLVMvRpeFyLOtVKF24CTOU7zLt3S00gNIJRsOp");
...
var generateCard = function generateCard(stripe) {
  var style = {
    base: {
      color: "#303238",
      fontSize: "14px",
...
var placeOrderAjax = function placeOrderAjax(formData) {
  axios__WEBPACK_IMPORTED_MODULE_1___default().post("/customer/orders", formData, {
    headers: {
      "Content-Type": "multipart/form-data"
    }
  }).then(function (res) {
